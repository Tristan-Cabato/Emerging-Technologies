...
export default function Login() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-saf-color p-4">
      <div className="w-full max-w-sm rounded-lg bg-saf-color-light p-8 shadow-md">
        {!isLoggedIn ? (
          <div className="flex flex-col gap-4">
            <h2 className="text-center text-2xl font-bold text-white">Mock Login</h2>
            ...
            <button
              ref={loginBtnRef}
              onClick={handleLogin}
              className="w-full rounded bg-blue-600/75 p-2 font-semibold text-white transition hover:bg-blue-700 active:bg-blue-800"
            >
              Login
            </button>
