...
function ConfirmModalComponent({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[9999]">
      ...
      {/* Modal content */}
      <div className="relative bg-saf-color-dark p-6 rounded-xl shadow-lg w-96 text-center border border-white/20">
        <p className="mb-4 text-white-800 font-medium">{message}</p>
